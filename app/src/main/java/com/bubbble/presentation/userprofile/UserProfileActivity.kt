...
class UserProfileActivity : BaseMvpActivity(), UserProfileView {
    ...
    override fun showUser(user: com.bubbble.core.models.User) {
    ...
    private fun setupProfilePager(user: com.bubbble.core.models.User) {
    ...
    override fun showUserProfileSharing(user: com.bubbble.core.models.User) {
