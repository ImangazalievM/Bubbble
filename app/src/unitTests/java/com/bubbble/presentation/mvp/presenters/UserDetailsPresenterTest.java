...
import com.bubbble.domain.global.models.Links;
import com.bubbble.domain.global.models.User;
import com.bubbble.presentation.userprofile.details.UserDetailsPresenter;
import com.bubbble.presentation.userprofile.details.UserDetailsView;
...
public class UserDetailsPresenterTest {
    ...
    public void setUp() {
        ...
        presenter = new UserDetailsPresenter(interactor, new TestSchedulersProvider(), TEST_USER_ID);
    }
